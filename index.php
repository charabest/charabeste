    ...
    <header class="navbar navbar-inverse navbar-fixed-top" role="banner">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php"><img src="img/logo.png" alt="Charabest Friend"></a>
            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="carousel-content centered">
                                    <h2 class="animation animated-item-1">Bienvenue sur CharaBestFriend </h2>
                                    <p class="animation animated-item-2"> Tout l'art réside dans le fait de devenir adulte sans devenir vieux. </p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="carousel-content center centered">
                                    <h2 class="animation animated-item-1">Joyeux anniversaire Ir. Chapelle</h2>
                                    <p class="animation animated-item-2">La valeur morale ne peut pas être remplacée par la valeur intelligence et j'ajouterai : Dieu merci ! </p>
                                    <br>
                ...
                <div class="item" style="background-image: url(img/slides/3.jpg)">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="carousel-content centered">
                                    <h2 class="animation animated-item-1">I want to know the thoughts of God.</h2>
                                    <p class="animation animated-item-2">L'escalier de la science est l'échelle de Jacob, il ne s'achève qu'aux pieds de Dieu. </p>
                                    <br>
									<a class="btn btn-md animation animated-item-3" href="#"> lire la suite</a>
                                </div>
                            </div>
                        </div>
                    </div>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="calltoaction-wrapper">
							<h3>Welcome to CharaBest <span style="color:#aec62c; text-transform:uppercase;font-size:24px;">Happy Birthday!</span> 25 ANS d'existance!</h3>
						</div>
					</div>
				</div>
			</div>
			...
			<ul class="grid cs-style-3">
	        	<div class="col-md-4 col-sm-6">
					<figure>
						...
						<figcaption>
							<h3>Convention</h3>
							<span>Ir. Chapelle</span>
							<a href="portfolio-item.php">Repportage</a>
						</figcaption>
					</figure>
	        	</div>	
				<div class="col-md-4 col-sm-6">
					<figure>
						...
						<figcaption>
							<h3>Ir Chapelle</h3>
							<span>Formation</span>
							<a href="portfolio-item.php">Live</a>
						</figcaption>
					</figure>
				</div>
				<div class="col-md-4 col-sm-6">
				...
				<div class="col-md-4 col-sm-6">
					<figure>
						...
						<figcaption>
							<h3>Safari</h3>
							<span>Chapelle Kabangu</span>
							<a href="portfolio-item.php">Birthday</a>
						</figcaption>
					</figure>
				</div>
				<div class="col-md-4 col-sm-6">
...
<hr>
	    ...
	    <div class="footer">
	    	<div class="container">
		    	...
		    	<div class="row">
		    		...
		    		<div class="col-footer col-md-4 col-xs-6">
		    			...
		    			<p class="contact-us-details">
	        				<b>Address:</b> 215 Miabi, Diulu, Mbujimayi, Kasai Oriental<br/>
	        				<b>Phone:</b> +243 813805253<br/>
	        				<b>Email:</b> <a href="mailto:extendsarl@gmail.com">kangakabangu@gmail.com</a>
	        			</p>
		    		</div>				
		    		<div class="col-footer col-md-4 col-xs-6">
		    	...
		    	<div class="row">
		    		<div class="col-md-12">
		    			<div class="footer-copyright">&copy; 2017">Extends</a> G_Happy</a>.</div>
		    		</div>
		    	</div>
		    </div>
	    </div>
